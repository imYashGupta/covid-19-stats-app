                ...
                <View style={styles.cards}>
                    ...
                    }
                    {
                        ...
                        <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                                <Text style={{ fontSize: 22, color: THEME.CONDITION}}>Help & Essentials Information</Text>
                                <Text style={{ fontSize: 14, color: "white",paddingHorizontal:20,textAlign:"center",marginTop:10 }}>Free Food,Covid-19 Labs and Hospitals.</Text>
                        </View>
                    </Card>
                    }
                </View>
